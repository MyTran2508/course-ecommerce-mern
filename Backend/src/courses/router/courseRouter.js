...
const {add, update, getById, getNewestCourse, getPopularCourse, getFiltedCourse, loadFile, uploadCourseImage, uploadCourseVideo} = require('../controller/courseController');
